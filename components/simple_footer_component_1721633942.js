...
*/
Vue.component("simple_footer_component_1721633942", {
    template: `
                ...
                <div id="footer-content" class="text-center">
                    <div class="flex">
                        <a id="footer-logo-link" href="#" class="flex-1 flex items-center justify-center mb-5 text-2xl font-semibold text-gray-900 dark:text-white">
                            ...
                            BookBuysr - Your Online Bookstore
                        </a>
                    </div>
                </div>
                <div class="flex">
                    <div id="footer-text" class="flex-1 block text-sm text-center text-gray-500 dark:text-gray-400">
                        Find your next great read at BookBuysr. Browse our vast selection of books across genres. Safe and secure online shopping. Affordable prices. Free shipping on orders over $35.
                    </div>
                </div>
            </div>
        </footer> 
